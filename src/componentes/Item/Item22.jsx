...
export const Item22 = ({info}) => {
	return(
		<div className="item__content">
			<a href="#" className="item__link">
				<div className="item__image-w">
					<img src={info.images[0]} alt="" className="item__image" width={230} height={230} />
				</div>
			</a>
			<a href="#" className="item__link">
				<div className="item__data-w">
					<div className="item__group">
						...
						<div className="item__group item__group--price-and-discount">
							<span className="item__group__element item__price">${info.precio}</span>
